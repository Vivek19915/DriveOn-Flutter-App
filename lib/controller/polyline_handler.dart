...
import 'package:driveon_flutter_app/constants/app_apikeys.dart';
...
getPolylines(LatLng pickUp,LatLng drop) async {
  ...
  try {
    var response = await http.get(Uri.parse(
        'https://maps.googleapis.com/maps/api/directions/json?origin=$pickLat%2C$pickLng&destination=$dropLat%2C$dropLng&avoid=ferries|indoor&transit_mode=bus&mode=driving&key=${ApiConstants.APIKEY}'));
