          ...
          child: Stack(
            children:[
              Positioned(
                ...
                right: 0,
                bottom: 80,
                //so that we can scroll our cards
              ...
              Positioned(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text("Add new card",style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold,color: greenColor),),
                      ...
                      },child: Icon(Icons.arrow_forward,color: Colors.white,),backgroundColor: greenColor,)
                    ],
                  ))
